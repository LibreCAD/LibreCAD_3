...
do
    ...
    (cat $OUTPUT_DIRECTORY/../librecad.dox; echo "INPUT=$module"; echo "OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY/$module"; echo "PROJECT_BRIEF=$module" ; cat doxygen/$module.cfg) | doxygen -
done
