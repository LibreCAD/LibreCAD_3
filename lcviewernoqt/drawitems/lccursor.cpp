...
Cursor::Cursor(int cursorSize, std::shared_ptr<DocumentCanvas> view, SnapManager_SPtr  snapManager, const lc::Color& xAxisColor, const lc::Color& yAxisColor) : _xAxisColor(xAxisColor), _yAxisColor(yAxisColor), _cursorSize(cursorSize) {
/*
