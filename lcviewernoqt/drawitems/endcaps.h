    ...
    namespace viewer {
        ...
        class EndCaps {
            public:
                 ...
                 */
                void addCap(unsigned int type,
                            std::function<void(LcPainter&,
                 ...
                 */
                void render(LcPainter& painter, unsigned int type,
                            double startX, double startY,
                            double endX, double endY,
                            double size) const;
            ...
            private:
                ...
                std::map<int, std::function<void(LcPainter&, double startX, double startY, double endX, double endY,
                                                 double size)>> _arrows;
        };
