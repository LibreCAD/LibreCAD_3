...
public:
    ...
    */
    ...
    void drawText(std::string const & value, double const angle, lc::TextConst::AttachmentPoint const attachmentPoint, lc::geo::Coordinate textlocation, LcPainter* painter, LcDrawOptions* options, const lc::geo::Area& rect) const;
};
