...
void LCLWPolyline::drawNoStoke(LcPainter &painter, const LcDrawOptions &options, const lc::geo::Area &rect) const {
...
void LCLWPolyline::drawStoke(LcPainter &painter, const LcDrawOptions &options, const lc::geo::Area &rect) const {
...
void LCLWPolyline::draw(LcPainter &painter, const LcDrawOptions &options, const lc::geo::Area &rect) const {
    if(autostroke()) { // We are in rendering
        drawStoke(painter, options, rect);
    } else { // We need shape only
        drawNoStoke(painter, options, rect);
    }
}
