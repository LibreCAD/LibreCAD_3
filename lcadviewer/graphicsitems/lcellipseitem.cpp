...
LCEllipseItem::LCEllipseItem(const std::shared_ptr<const lc::Ellipse> ellipse) : LCGraphicsItem(), _ellipse(ellipse) {
}
...
const std::shared_ptr<const lc::CADEntity> LCEllipseItem::entity() const {
    return _ellipse;
}
