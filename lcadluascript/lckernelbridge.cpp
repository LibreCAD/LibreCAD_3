...
void LCLua::importLCKernel() {
    ...
    state["lc"]["entity"]["LWPolyline"].setClass(kaguya::UserdataMetatable<lc::entity::LWPolyline, kaguya::MultipleBase<lc::entity::CADEntity, lc::entity::Snapable, lc::entity::Draggable>>()
        .setConstructors<lc::entity::LWPolyline(std::vector<lc::entity::LWVertex2D>, double, double, double, bool, geo::Coordinate, meta::Layer_CSPtr, meta::MetaInfo_CSPtr, meta::Block_CSPtr), lc::entity::LWPolyline(const lc::entity::LWPolyline_CSPtr &, bool)>()
    ...
    state["lc"]["geo"]["Arc"].setClass(kaguya::UserdataMetatable<lc::geo::Arc, kaguya::MultipleBase<lc::geo::Base, lc::Visitable>>()
        .setConstructors<lc::geo::Arc(lc::geo::Coordinate, double, double, double, bool)>()
    ...
    state["lc"]["storage"]["Document"].setClass(kaguya::UserdataMetatable<lc::storage::Document>()
        ...
        .addFunction("EntityContainer<lc::entity::CADEntity_CSPtr>>", &lc::storage::Document::entityContainer)
    ...
    state["lc"]["storage"]["DocumentImpl"].setClass(kaguya::UserdataMetatable<lc::storage::DocumentImpl, lc::storage::Document>()
        ...
        .addFunction("EntityContainer<lc::entity::CADEntity_CSPtr>>", &lc::storage::DocumentImpl::entityContainer)
    ...
    state["lc"]["storage"]["QuadTree"].setClass(kaguya::UserdataMetatable<lc::storage::QuadTree<lc::entity::CADEntity_CSPtr>, lc::storage::QuadTreeSub<lc::entity::CADEntity_CSPtr>>()
        .setConstructors<lc::storage::QuadTree<lc::entity::CADEntity_CSPtr>(int, const geo::Area &, short, short), lc::storage::QuadTree<lc::entity::CADEntity_CSPtr>(const geo::Area &), lc::storage::QuadTree<lc::entity::CADEntity_CSPtr>(const lc::storage::QuadTree<lc::entity::CADEntity_CSPtr>&)>()
    ...
    state["lc"]["storage"]["QuadTreeSub"].setClass(kaguya::UserdataMetatable<lc::storage::QuadTreeSub<lc::entity::CADEntity_CSPtr>>()
        .setConstructors<lc::storage::QuadTreeSub<lc::entity::CADEntity_CSPtr>(int, const geo::Area &, short, short), lc::storage::QuadTreeSub<lc::entity::CADEntity_CSPtr>(const geo::Area &), lc::storage::QuadTreeSub<lc::entity::CADEntity_CSPtr>(const lc::storage::QuadTreeSub<lc::entity::CADEntity_CSPtr>&)>()
