...
void LCLua::importLCKernel() {
    ...
    state["lc"]["entity"]["Line"].setClass(kaguya::UserdataMetatable<lc::entity::Line, kaguya::MultipleBase<lc::entity::CADEntity, lc::geo::Vector, lc::entity::Snapable, lc::entity::Draggable>>()
            .addStaticFunction("new", [](const geo::Coordinate & start, const geo::Coordinate & end, meta::Layer_CSPtr layer, meta::MetaInfo_CSPtr metainfo, meta::Block_CSPtr block) {
                return std::make_shared<const lc::entity::Line>(start, end, layer, metainfo, block);
            })
