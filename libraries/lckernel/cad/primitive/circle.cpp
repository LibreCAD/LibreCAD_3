...
Circle::Circle(const geo::Coordinate& center, double radius, const QList<std::tr1::shared_ptr<const lc::MetaType> >& metaTypes) : CADEntity(metaTypes),  geo::Circle(center, radius) {
}
