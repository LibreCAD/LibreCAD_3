    ...
    class SelectionManager : public QObject {
        ...
        public:
            ...
            /**
              ...
              * @return QList<boost::shared_ptr<const lc::CADEntity> > List of CAD Entities
              */
            virtual QList<boost::shared_ptr<const lc::CADEntity> > getEntitiesInArea(const geo::Area& area) const = 0;
