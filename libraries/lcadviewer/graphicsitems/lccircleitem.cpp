...
LCCircleItem::LCCircleItem(const std::tr1::shared_ptr<const lc::Circle> circle) : LCGraphicsItem(), _circle(circle) {
}
...
const std::tr1::shared_ptr<const lc::CADEntity> LCCircleItem::entity() const {
    return _circle;
}
