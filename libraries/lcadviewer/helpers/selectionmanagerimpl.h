...
class SelectionManagerImpl : public lc::SelectionManager {
    public:
        SelectionManagerImpl(boost::shared_ptr<lc::LayerManager> layerManager, QGraphicsView* scene);
        ...
        virtual QList<boost::shared_ptr<const lc::CADEntity> > getEntitiesInArea(const lc::geo::Area& area) const;
