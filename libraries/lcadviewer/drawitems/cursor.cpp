...
Cursor::Cursor(int cursorSize, QCachedGraphicsView* graphicsView, boost::shared_ptr<SnapManager>  snapManager, const QColor& xAxisColor, const QColor& yAxisColor) : _xAxisColor(xAxisColor), _yAxisColor(yAxisColor), _cursorSize(cursorSize) {
