    ...
    namespace entity {
        ...
        class Snapable {
            public:
                ...
                snapPoints(const geo::Coordinate& coord, const SimpleSnapConstrain& simpleSnapConstrain,
                           double minDistanceToSnap, int maxNumberOfSnapPoints) const = 0;
                 ...
                 */
                static void
                remove_ifDistanceGreaterThen(std::vector<EntityCoordinate>& points, const geo::Coordinate& reference,
                 ...
                 */
                static void snapPointsCleanup(std::vector<EntityCoordinate>& points, const geo::Coordinate& reference,
