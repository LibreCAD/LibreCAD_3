...
namespace lc {
    ...
    class Snapable {
        public:
             ...
             */
            static void snapPointsCleanup(std::vector<EntityCoordinate> &points, const geo::Coordinate &reference, const int maxNumberOfSnapPoints, const double minDistanceToSnap) {
