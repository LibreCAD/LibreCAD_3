...
namespace lc {
    ...
    class EntityVisitor {
        public:
            ...
            virtual void visit(shared_ptr<const lc::Line>, shared_ptr<const lc::Spline>) = 0;
            ...
            virtual void visit(shared_ptr<const lc::Circle>, shared_ptr<const lc::Spline>) = 0;
            ...
            virtual void visit(shared_ptr<const lc::Arc>, shared_ptr<const lc::Spline>) = 0;
            ...
            virtual void visit(shared_ptr<const lc::Ellipse>, shared_ptr<const lc::Spline>) = 0;
            ...
            virtual void visit(shared_ptr<const lc::Text>, shared_ptr<const lc::Spline>) = 0;

            virtual void visit(shared_ptr<const lc::Spline> Spline, shared_ptr<const lc::Line> line) = 0; //{visit(line, ellipse);}
            virtual void visit(shared_ptr<const lc::Spline> Spline, shared_ptr<const lc::Circle> circle) = 0; //{visit(circle, ellipse);}
            virtual void visit(shared_ptr<const lc::Spline> Spline, shared_ptr<const lc::Arc> arc) = 0; //{visit(arc, ellipse);}
            virtual void visit(shared_ptr<const lc::Spline> Spline, shared_ptr<const lc::Ellipse> ellipse) = 0;
            virtual void visit(shared_ptr<const lc::Spline> Spline, shared_ptr<const lc::Text> text) = 0;
            virtual void visit(shared_ptr<const lc::Spline>, shared_ptr<const lc::Spline>) = 0;
    };
}
