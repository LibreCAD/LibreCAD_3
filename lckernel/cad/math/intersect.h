...
public:
    ...
    bool operator()(const lc::geo::Vector& v, const lc::geo::Coordinate& p) {
        return (*this)(p,v);
    };
    ...
    bool operator()(const lc::geo::Circle& c, const lc::geo::Coordinate& p) {
        return (*this)(p,c);
    };
    ...
    bool operator()(const lc::geo::Arc& a, const lc::geo::Vector& v) {
        return (*this)(v,a);
    };
    bool operator()(const lc::geo::Arc& a, const lc::geo::Coordinate& p) {
        return (*this)(p,a);
    };
    bool operator()(const lc::geo::Arc& a, const lc::geo::Circle& c) {
        return (*this)(c,a);
    };
    ...
    bool operator()(const lc::geo::Ellipse& e, const lc::geo::Vector& v) {
        return (*this)(v,e);
    };
    bool operator()(const lc::geo::Ellipse& e, const lc::geo::Coordinate& p) {
        return (*this)(p,e);
    };
    bool operator()(const lc::geo::Ellipse& e, const lc::geo::Circle& c) {
        return (*this)(c,e);
    };
    bool operator()(const lc::geo::Ellipse& e, const lc::geo::Arc& a) {
        return (*this)(a,e);
    };
    ...
    bool operator()(const lc::geo::Spline& s, const lc::geo::Vector& v) {
        return (*this)(v,s);
    };
    bool operator()(const lc::geo::Spline& s, const lc::geo::Coordinate& p) {
        return (*this)(p,s);
    };
    bool operator()(const lc::geo::Spline& s, const lc::geo::Circle& c) {
        return (*this)(c,s);
    };
    bool operator()(const lc::geo::Spline& s, const lc::geo::Arc& a) {
        return (*this)(a,s);
    };
    bool operator()(const lc::geo::Spline& s, const lc::geo::Ellipse& e) {
        return (*this)(e,s);
    };
    ...
    bool operator()(const lc::entity::LWPolyline& lwp, const lc::geo::Coordinate& p) {
        return (*this)(p,lwp);
    };
    bool operator()(const lc::entity::LWPolyline& lwp, const lc::geo::Circle& c) {
        return (*this)(c,lwp);
    };
    bool operator()(const lc::entity::LWPolyline& lwp, const lc::geo::Arc& a) {
        return (*this)(a,lwp);
    };
    bool operator()(const lc::entity::LWPolyline& lwp, const lc::geo::Ellipse& e) {
        return (*this)(e,lwp);
    };
    bool operator()(const lc::entity::LWPolyline& lwp, const lc::geo::Spline& s) {
        return (*this)(s,lwp);
    };
