...
MText::MText(const geo::Coordinate& insertionPoint,
      ...
      const double angle, const Layer_CSPtr layer) : CADEntity(layer), geo::MText(insertionPoint, height,width, valign, halign, drawingDirection,
...
MText::MText(const geo::Coordinate& insertionPoint,
      ...
      const std::string& text_value,
      const std::string& style,
      const double angle, const Layer_CSPtr layer, const std::list<MetaType_CSPtr>&metaTypes) : CADEntity(layer), geo::MText(insertionPoint, height,width, valign, halign, drawingDirection,
                                                                                                                             lineSpacingStyle, lineSpacingFactor, text_value, style,
                                                                                                                             angle) {
