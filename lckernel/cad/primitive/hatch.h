...
public:
    const lc::objects::Pattern& getPattern() const {
        return _pattern;
    }
    void setPattern(const lc::objects::Pattern& pat) {
        _pattern=pat;
    }
    const lc::geo::Region& getRegion() const {
        return _region;
    }
    void setRegion(const lc::geo::Region& reg) {
        _region=reg;
    }
