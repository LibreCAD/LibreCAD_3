...
namespace lc {
    ...
    class Spline : public std::enable_shared_from_this<Spline>, public CADEntity, public geo::Spline, public Snapable {
        public:
            Spline(const QList<geo::Coordinate>& control_points, const int degree, const bool closed, const std::shared_ptr<const Layer> layer);
            Spline(const QList<geo::Coordinate>& control_points, const int degree, const bool closed, const std::shared_ptr<const Layer> layer, const QList<std::shared_ptr<const MetaType> >& metaTypes);
