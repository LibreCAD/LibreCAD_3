...
LineCreateOperation::LineCreateOperation(std::shared_ptr<lc::Document> document, lc::StorageManager_SPtr storageManager, lc::Layer_CSPtr layer, QGraphicsView* graphicsView, SnapManager_SPtr  snapManager)
