...
TEST(WindowManagerTest, NewFileTest) {
    ...
    lc::ui::MainWindow* prevWindow = lc::ui::WindowManager::getMainWindows()[1];
    ...
    EXPECT_TRUE(prevWindow != lc::ui::WindowManager::getMainWindows()[0] && prevWindow != lc::ui::WindowManager::getMainWindows()[1]);
}
