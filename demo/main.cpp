...
int main(int argc, char* argv[]) {
    ...
    lc::Line* l2 = new lc::Line(new lc::Coordinate(10.0, 10.0), new lc::Coordinate(10.0, 10.0), metaTypes << new lc::Color(10, 10, 10));
    // Create a line with meta attributes, Color Width defaults to BYLAYER, Line set to 1.5mm
    lc::Line* l3 = new lc::Line(new lc::Coordinate(10.0, 10.0), new lc::Coordinate(10.0, 10.0), metaTypes << new lc::LineWidth(1.5));
