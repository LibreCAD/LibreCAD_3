...
class TrimOperation : public GuiOperation {
    ...
    public:
        TrimOperation(lc::Document* document, shared_ptr<lc::StorageManager> entityManager, QGraphicsView* graphicsView, shared_ptr<SnapManager>  snapManager,  shared_ptr<lc::SelectionManager> selectionManager);
    ...
    private:
        ...
        shared_ptr<lc::StorageManager>  _entityManager;
