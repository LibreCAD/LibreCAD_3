...
SnapManagerImpl::SnapManagerImpl(LCADCairoViewer* graphicsView, std::shared_ptr<lc::SelectionManager> selectionmanager, std::shared_ptr<const lc::Snapable> grid, double distanceToSnap)  : _selectionmanager(selectionmanager), _grid(grid), _distanceToSnap(distanceToSnap) {
