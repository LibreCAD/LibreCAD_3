...
class SnapManagerImpl : public SnapManager {
    ...
    public:
         ...
         *
         * \param viewer    Pointer to a LCADCairoViewer object
         ...
         * \sa lc::SnapManager
         */
        SnapManagerImpl(LCADCairoViewer* viewer, std::shared_ptr<lc::SelectionManager> _selectionmanager, std::shared_ptr<const lc::Snapable> grid, double distanceToSnap);
